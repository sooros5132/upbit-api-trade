...
const Footer: React.FC<FooterProps> = ({}) => {
  return (
    <>
      <footer className='p-10 footer bg-base-200 text-base-content  lg:py-4 '>
        <div className='mx-auto'>
          <p>
            ...
            정보에 대하여 어떠한 책임을 지지 않습니다. 디지털 자산 투자에 대한 금전적 손실은 본인
            책임이며 투자에 유의하시기 바랍니다.
          </p>
          <p className='w-full text-right text-gray-500 hover:[&>a]:underline lg:hidden'>
            powerd by{' '}

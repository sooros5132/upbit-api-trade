...
const MarketTable: React.FC<MarketTableProps> = ({ isLastUpdatePage }) => {
  ...
  return (
    <div className='w-full max-w-screen-xl overflow-hidden sm:m-0 flex flex-col'>
      ...
      {!hidden && (
        <div className='sm:overflow-y-auto flex-auto font-mono text-right [&_th]:px-0.5 [&_th]:py-1.5 [&_td]:px-0.5 [&_td]:py-1.5 [&_td]:whitespace-nowrap [&_tbody_tr]:border-b [&_tbody_tr]:cursor-pointer [&_tbody_tr]:min-w-[40px] [&_tbody_tr:hover_td]:bg-white/5'>
